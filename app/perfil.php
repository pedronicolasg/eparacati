        ...
        <div class="bg-white p-4 rounded-lg shadow-lg mb-6 dark:bg-gray-800">
          ...
          <ul class="text-gray-600 dark:text-gray-400">
              ...
              <li class="flex justify-between">
                ...
                <span>
                  ...
                  if ($currentUser['role'] == 'gestao') {
                    echo '<a href="./dashboard/pages/turmas.php?id=' . htmlspecialchars(Security::hide($user['class_id'])) . '" class="font-medium text-green-600 dark:text-green-600">' . htmlspecialchars($class['name']) . '</a>';
                  } else {
            ...
            <li class="flex justify-between">
              ...
              <span>
                <?php echo Format::date($user['created_at']); ?>
              </span>
            </li>
            ...
            <?php if (isset($user['updated_at'])): ?>
              <li class="flex justify-between">
                ...
                <span>
                  <?php echo Format::date($user['updated_at']) ?>
                </span>
              </li>
            <?php endif; ?>
          ...
          <div class="border-b border-gray-200 mb-4 dark:border-gray-700">
            <ul class="flex">
              <li class="mr-6"><a
                  ...
                  href="perfil.php?id=<?php echo htmlspecialchars(Security::hide($userId)); ?>">Atividade</a></li>
              <?php if ($isCurrentUser || $currentUser['role'] == 'gestao'): ?>
                <li class="mr-6"><a
                    ...
                    href="perfil.php?id=<?php echo htmlspecialchars(Security::hide($userId) . '&editPanel'); ?>">Editar</a>
                </li>
              <?php endif; ?>
            </ul>
          </div>
