<div id="userBulkAddModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full max-w-md max-h-[90vh] overflow-y-auto bg-white dark:bg-gradient-to-br dark:from-slate-900 dark:to-slate-800 rounded-2xl shadow-2xl border border-purple-500/20 dark:border-purple-500/10">
        <div class="flex items-center justify-between p-5 border-b border-purple-500/20 dark:border-purple-500/10 bg-gray-50 dark:bg-slate-900">
        ...
        <form action="../../src/controllers/user/bulkregister.php" method="POST" enctype="multipart/form-data" class="p-5 space-y-6">
            <div class="bg-gray-50 dark:bg-slate-800/50 rounded-2xl p-6 border border-gray-200 dark:border-white/5 mb-6">
                <div class="text-center mb-6">
                    <p class="text-gray-700 dark:text-gray-300">Importe vários usuários de uma só vez usando uma planilha.</p>
                    <p class="text-gray-500 dark:text-gray-400 text-sm">Formatos suportados: XLSX, CSV</p>
                </div>

                <div class="bg-white dark:bg-slate-800/70 rounded-2xl p-5 border border-gray-200 dark:border-white/5 hover:border-purple-500/30 transition-all duration-300 group">
                    <div class="flex items-center gap-3 mb-3">
                        <div class="w-10 h-10 rounded-full bg-purple-100 dark:bg-purple-500/20 flex items-center justify-center">
                            <i class="fas fa-users text-purple-600 dark:text-purple-400"></i>
                        </div>
                        <h3 class="font-medium text-gray-800 dark:text-white">Usuários Iniciais</h3>
                    </div>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">Importe uma planilha com os usuários para cadastro em massa.</p>
                    <div class="file-upload-container">
                        <label class="relative block w-full">
                            <input type="file" accept=".csv, .xlsx" name="excel_file" id="excel_file" class="sr-only peer file-input" data-type="users" required />
                            <div class="h-20 w-full border-2 border-dashed border-gray-300 dark:border-gray-600 peer-hover:border-purple-500/50 rounded-xl flex flex-col items-center justify-center cursor-pointer transition-all duration-300 upload-area">
                                <i class="fas fa-cloud-upload text-gray-500 dark:text-gray-500 peer-hover:text-purple-600 dark:peer-hover:text-purple-400 text-xl mb-1 transition-colors"></i>
            ...
            <div class="bg-sky-100 dark:bg-sky-500/10 border border-sky-200 dark:border-sky-500/20 rounded-xl p-4">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <div class="mt-3">
                            <a href="../../../public/templates/spreadsheet/Modelo_Cadastro_Usuários.xlsx" download class="text-sm flex items-center gap-2 text-purple-600 dark:text-purple-400 hover:text-purple-500 dark:hover:text-purple-300 transition-colors bg-purple-100 dark:bg-purple-500/10 hover:bg-purple-200 dark:hover:bg-purple-500/20 rounded-lg px-4 py-2 w-fit">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const fileInput = document.querySelector('#userBulkAddModal .file-input');
        if (fileInput) {
            fileInput.addEventListener('change', function(e) {
                ...
                uploadIcon.className = 'fas fa-check-circle text-2xl text-purple-600 dark:text-purple-400';
                ...
                if (extension === 'csv') {
                    fileIcon.className = 'fas fa-file-csv mr-2 text-purple-600 dark:text-purple-400';
                } else {
                    fileIcon.className = 'fas fa-file-excel mr-2 text-purple-600 dark:text-purple-400';
                }
                ...
                `;
                    ...
                    uploadArea.classList.remove('border-solid', 'border-purple-500');
