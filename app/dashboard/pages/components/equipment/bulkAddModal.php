<div id="equipmentBulkAddModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full max-w-md max-h-full bg-white rounded-lg shadow-lg dark:bg-gray-800">
        ...
        <form action="../../src/handlers/equipment/bulkregister.php" method="POST" enctype="multipart/form-data"
            class="p-4 md:p-5">
            <div class="grid gap-4 mb-4 grid-cols-2">
                <div class="col-span-2">
                    <a href="../../../public/assets/docs/Modelo_Cadastro_Equipamentos.xlsx" type="button"
