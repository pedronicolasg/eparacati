  ...
  <div class="max-w-6xl mx-auto px-4">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
      <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-center p-6 rounded-lg shadow hover:shadow-lg transition">
        <i class="fas fa-user-check text-4xl mb-4 text-gray-700 dark:text-gray-300"></i>
        <p class="text-gray-800 dark:text-gray-200 font-bold text-lg">EPresence</p>
        <div class="h-[4px] bg-green-600 mt-4"></div>
      </div>
      <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-center p-6 rounded-lg shadow hover:shadow-lg transition">
        <i class="fas fa-laptop text-4xl mb-4 text-gray-700 dark:text-gray-300"></i>
        <p class="text-gray-800 dark:text-gray-200 font-bold text-lg">Agendar Equipamentos</p>
        <div class="h-[4px] bg-green-600 mt-4"></div>
      </div>
    </div>
  </div>
