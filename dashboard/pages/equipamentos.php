...
$editEquipmentId = isset($_GET['id']) ? Utils::show($_GET['id']) : null;
if (!empty($editEquipmentId)) {
  $currentEquipment = $equipmentManager->getInfo($editEquipmentId);
}
?>
<!DOCTYPE html>
...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
  ...
  <?php
  if (empty($editEquipmentId)) {
    include_once "includes/components/equipmentAddModal.php";
    include_once "includes/components/equipmentBulkAddModal.php"; ?>
    <script src="../../assets/js/equipmentAddModalController.js"></script>
    <script src="../../assets/js/equipmentBulkAddModalController.js"></script>
    <script src="../../assets/js/equipmentSearchBarController.js"></script>
    <script src="../../assets/js/equipmentFilterDropdown.js"></script>
  <?php } ?>
</body>
