      ...
      <div class="mb-6 md:w-1/2">
        ...
        <div class="flex flex-col items-center space-y-4">
          ...
          <div class="flex w-full space-x-2">
            ...
            <button type="button"
              onclick="if(confirm('Tem certeza que deseja deletar a imagem?')) { window.location.href='../../methods/handlers/equipment/deleteImage.php?id=<?php echo Utils::hide($currentEquipment['id']); ?>'; }"
