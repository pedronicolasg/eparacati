            ...
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
              ...
              ?>
                ...
                <tr class="bg-blue-50 dark:bg-blue-900/20">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400"><?= Utils::formatActionName($currentLog['action']) ?></td>
                  <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">Registro atual</td>
                </tr>
              <?php } else { ?>
                <tr class="hover:bg-gray-100 dark:hover:bg-[#2a323c] border-b border-gray-200 dark:border-gray-700/50 cursor-pointer" onclick="window.location.href='./registros.php?id=<?= Utils::hide($log['id']) ?>'">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400"><?= Utils::formatActionName($log['action']) ?></td>
        ...
        <div class="p-6">
          <dl class="space-y-4">
            ...
            <div>
              ...
              <dd class="mt-1 text-sm text-gray-800 dark:text-gray-200"><?= Utils::formatActionName($currentLog['action']) ?></dd>
            </div>
            <div>
              <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Área afetada</dt>
              <dd class="mt-1 text-sm text-gray-800 dark:text-gray-200"><?= Utils::formatTableName($currentLog['target_table']) ?></dd>
            </div>
            <div>
