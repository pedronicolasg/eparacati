...
$logId = isset($_GET['id']) ? Utils::show($_GET['id']) : null;
if (!empty($logId)) {
...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
  <div class="min-h-full">
    ...
    <?php if (!empty($logId)) {
      if (empty($currentLog)) {
        ...
        include_once 'includes/view/registro.php'; ?>
        <script src="includes/view/js/registro.js"></script>
      <?php
      }
    } else { ?>
                ...
                <div id="dropdownRadio"
                  ...
                  <ul class="p-3 space-y-1 text-sm text-gray-700 dark:text-gray-200"
                    ...
                    foreach ($actions as $actionname) {
                      ...
                      $label = Utils::formatActionName($actionname);
                    ?>
                      <li>
                        <div class="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                ...
                <tbody>
                  ...
                  ?>
                    ...
                    <tr class="hover:bg-gray-100 dark:hover:bg-[#2a323c] border-b border-gray-200 dark:border-gray-700/50 cursor-pointer" onclick="window.location.href='./registros.php?id=<?= Utils::hide($log['id']) ?>'">
                      ...
                      <td class="px-4 py-2"><?= Utils::formatActionName($log['action']) ?></td>
                      <td class="px-4 py-2"><?= Utils::formatTableName($log['target_table']) ?></td>
  ...
  <script src="../../assets/js/logsFilterDropdown.js"></script>
  <script src="../../assets/js/logsSearchBarController.js"></script>
<?php } ?>
</body>
